...
import { Div } from './IntroductionBgAnimationStyle';

// Introduction background animation component
const IntroductionBgAnimation = () => (
  <Div>
    ...
    >
      ...
      <defs>
        ...
        {/* Radial gradient definition for second path */}
        <radialGradient
          id="paint1_radial"
          cx="0"
          cy="0"
        ...
        {/* Radial gradient definition for third path */}
        <radialGradient
          id="paint2_radial"
          cx="0"
          cy="0"
        ...
        {/* Linear gradient definition for animation */}
        <linearGradient
          id="paint3_linear"
          x1="295.043"
          y1="193.116"
...
export default IntroductionBgAnimation;
